...
final class MooShellIntegrationTests {
    ...
    @Test func exportsTerminalIdentityWithoutAutomaticInjection () {
        ...
        let result = MooShellIntegration.configure(
            input,
            automatic: false,
    ...
    @Test func injectsSupportedBashAndPreservesFlags () throws {
        let resources = try #require(MooShellIntegration.resourcesDirectory)
        let input = LaunchParameters(
    ...
    @Test func doesNotInjectNoninteractiveShellCommands () throws {
        ...
        let bashResult = MooShellIntegration.configure(
            bash,
            automatic: true,
            resourcesDirectory: resources,
            processEnvironment: [:],
        ...
        let nushellResult = MooShellIntegration.configure(
            nushell,
            automatic: true,
            resourcesDirectory: resources,
            processEnvironment: [:],
