...
struct OpenTerminalWindowIntent: AppIntent {
    ...
    static let description = IntentDescription("Opens a Moo terminal window.")
...
struct OpenTerminalTabIntent: AppIntent {
    ...
    static let description = IntentDescription("Opens a Moo terminal tab.")
    static let openAppWhenRun = true
...
struct MooAppShortcuts: AppShortcutsProvider {
