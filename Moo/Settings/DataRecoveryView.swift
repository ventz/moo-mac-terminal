...
struct DataRecoveryView: View {
    ...
    var body: some View {
        Group {
            if issueCenter.issues.isEmpty {
                ContentUnavailableView(
                    ...
                    description: Text("Moo found no data that needs attention.")
                )
            } else {
                issueList
            }
        ...
        .confirmationDialog(
            ...
            Text("Moo will stop loading \(issue.sourceURL.lastPathComponent). You can recover it from Trash.")
        }
    }
